...
صندوق رسالةٍ يخبرك بالضبط بما عليك تثبيته، بدل أن تفشل بصمت. كما تُحذّرك إن وجدت
**Python 3.14+ أو `pywinpty` 3.x** — فهذه التركيبة تُجمّد البرامج التفاعليّة وتجعل
الطرفيّة بطيئة — وتُرشدك للعودة إلى الحزمة المختبَرة (3.13 مع `pywinpty` 2.x).
