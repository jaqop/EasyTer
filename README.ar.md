...
- **بدون Git:** انقر على الزر الأخضر **`<> Code`** أعلى هذه الصفحة ثمّ
  **Download ZIP**، وبعدها انقر بزر الفأرة الأيمن على الملف المضغوط واختر
  **Extract All...** (فكّ الضغط قبل تشغيل أيّ ملف من داخله).
- **باستخدام Git:**
  ```sh
...
انقر نقراً مزدوجاً على **`install.bat`** داخل مجلّد `EasyTer` الذي فككت ضغطه أو
استنسخته. يعمل من أيّ مجلّد: يعرض مكان EasyTer،
